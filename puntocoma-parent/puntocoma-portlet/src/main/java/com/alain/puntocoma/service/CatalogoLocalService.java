...
/**
 * Provides the local service interface for Catalogo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Alain
 * @see CatalogoLocalServiceUtil
...
public interface CatalogoLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link CatalogoLocalServiceUtil} to access the catalogo local service. Add custom service methods to {@link com.alain.puntocoma.service.impl.CatalogoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
