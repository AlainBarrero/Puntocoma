 ...
 * @generated
 */
public class CatalogoLocalServiceClp implements CatalogoLocalService {
    ...
    public com.alain.puntocoma.model.Catalogo addCatalogo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(catalogo) });
        } catch (Throwable t) {
    ...
    public com.alain.puntocoma.model.Catalogo createCatalogo(long catalogoId) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { catalogoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.alain.puntocoma.model.Catalogo deleteCatalogo(long catalogoId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { catalogoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.alain.puntocoma.model.Catalogo fetchCatalogo(long catalogoId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { catalogoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
