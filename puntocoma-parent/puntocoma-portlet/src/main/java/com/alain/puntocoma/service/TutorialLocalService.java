...
/**
 * Provides the local service interface for Tutorial. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Alain
 * @see TutorialLocalServiceUtil
...
public interface TutorialLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link TutorialLocalServiceUtil} to access the tutorial local service. Add custom service methods to {@link com.alain.puntocoma.service.impl.TutorialLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
