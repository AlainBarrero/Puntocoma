 ...
 * @generated
 */
public class TutorialLocalServiceClp implements TutorialLocalService {
    ...
    public com.alain.puntocoma.model.Tutorial addTutorial(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(tutorial) });
        } catch (Throwable t) {
    ...
    public com.alain.puntocoma.model.Tutorial createTutorial(long articleId) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { articleId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.alain.puntocoma.model.Tutorial deleteTutorial(long articleId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { articleId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.alain.puntocoma.model.Tutorial fetchTutorial(long articleId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { articleId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.alain.puntocoma.model.Tutorial getTutorial(long articleId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { articleId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
